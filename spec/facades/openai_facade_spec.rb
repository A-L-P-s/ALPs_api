...
RSpec.describe OpenaiFacade, :vcr do
  describe "class methods" do
    ...
    it "can :check_challenge_with_ai and return an updated challenge" do
      ...
      expect(@tr_challenge1.sentences[0].ai_sent).to eq("Yarın annem beni havalimanına arabasıyla bırakacak.")
      expect(@tr_challenge1.sentences[0].ai_explanation).to eq("Changed 'araba kullanacak' to 'arabasıyla bırakacak' to use the verb 'bırakmak' which means 'to drop off' and to use the correct tense of 'gelecek zaman' (-ecek).")
    end
