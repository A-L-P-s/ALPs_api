...
Sentence.create(id: 14, challenge_id: 52, grammar_point: "ulaçlar amaç (-mek için)", eng_grammar_point: "in order to", user_sent: "Nişanlısının ailesinin onayını kazanmak için tuzlu kahve içmeye aldırmadi.", ai_sent: "Nişanlısının ailesinin onayını kazanmak için tuzlu kahve içmeye aldırmadi.")
